...
export default function SortMenu({ setSort }: SortMenuProps) {
  return (
    <>
      ...
      <p className="mr-1 text-slate-500 ml-6">Sort </p>
      <div className="relative my-6 md:w-60 mr-auto ">
        <select
          id="id-10"
          name="id-10"
          required
